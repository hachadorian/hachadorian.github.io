...
const Projects = () => {
  let alignment = true;
  return (
    <div className="grid grid-cols-1 justify-items-center text-white pt-20">
      <div className="mt-5 w-1/4 p-5 text-white bg-gray-900 leading-loose mb-10 border-t-2">
